...
class CatalogClientTests {
    ...
    void setup() throws Exception {
        ...
        server.createContext("/api/v1/catalog/1", exchange -> {
    ...
    @Test
    void forwardsBearerAndPreservesDecimals() {
    ...
    @Test
    void distinguishesMissingProductFromUpstreamFailure() {
    ...
    @Test
    void rejectsMalformedOrInvalidCatalogResponses() {
